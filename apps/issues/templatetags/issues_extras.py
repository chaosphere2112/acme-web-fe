...
<div data-id="{id}" class="qb_question">
        <button class="btn btn-danger btn-xs remove_question">
...
"""
    ...
    return markup.format(id=question.id, question=question.question,
                         yes=yes, no=no)


def render_category(category, escape):
    t = """<div>
    <button class="btn btn-danger btn-xs remove_category">
        <span class="glyphicon glyphicon-remove"></span>
    </button>
    <span class="qb_category">{name}</span>
    </div>"""
...
def render_input():
    ...
    <input type="text" class="form-control new_text" placeholder="%s">
    <span class="input-group-btn">
        <button class="btn btn-primary save_button" type="button">
        <span class="glyphicon glyphicon-plus"></span>
        </button>
    </span>
</div>""" % "Add question or category..."
